...
export function Landing({ googleConfigured }: { googleConfigured: boolean }) {
  ...
  useEffect(() => {
    ...
    // Someone who asked for less motion, or is saving data, gets the poster and a play button instead of a 600 KB download.
    ...
    <main className="home-width">
      ...
      <section className="home-intro" aria-labelledby="home-heading">
        <div className="home-intro-heading">
          <h1 id="home-heading">Auto-apply to SEEK and Indeed jobs in Australia.<em>Job hunting is a job. Not anymore 😌</em></h1>
