        ...
        <div className="home-hero-videos">
          <div className="home-hero-figure">
            <picture className="home-story-slice home-story-old">
              ...
              <img src="/hero/old-way-vs-myasis.png" width="1627" height="894" alt="The old way: search and apply to many jobs, get rejections, feel stressed. The Myasis way: Myasis finds and matches jobs for you, you get better matches, and whether accepted or rejected there are more opportunities ahead." />
            </picture>
            <picture className="home-story-slice home-story-myasis" aria-hidden="true">
              <source srcSet="/hero/old-way-vs-myasis.webp" type="image/webp" />
              <img src="/hero/old-way-vs-myasis.png" width="1627" height="894" alt="" />
            </picture>
          </div>
